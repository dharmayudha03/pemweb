...
class PolaMakanPolicy
{
    ...
    {
        return $user->can('view_any_pola::makan');
    }
    ...
    {
        return $user->can('view_pola::makan');
    }
    ...
    {
        return $user->can('create_pola::makan');
    }
    ...
    {
        return $user->can('update_pola::makan');
    }
    ...
    {
        return $user->can('delete_pola::makan');
    }
    ...
    {
        return $user->can('delete_any_pola::makan');
    }
     ...
     */
    public function replicate(User $user, PolaMakan $polaMakan): bool
    {
