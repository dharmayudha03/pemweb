...
class AktifitasPolicy
{
    ...
    {
        return $user->can('view_any_aktifitas');
    }
    ...
    {
        return $user->can('view_aktifitas');
    }
    ...
    {
        return $user->can('create_aktifitas');
    }
    ...
    {
        return $user->can('update_aktifitas');
    }
    ...
    {
        return $user->can('delete_aktifitas');
    }
    ...
    {
        return $user->can('delete_any_aktifitas');
    }
     ...
     */
    public function replicate(User $user, Aktifitas $aktifitas): bool
    {
