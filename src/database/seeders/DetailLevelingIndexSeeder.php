    ...
    public function run(): void
    {
        ...
        $detail_leveling = array(
            ...
            array(
                ...
                'criteria_evidence' => 'Konteks pengaturan/norma pengoperasian Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah bagi sebagian unit kerja/perangkat daerah tertuang dalam peraturan/kebijakan kepala unit kerja/perangkat daerah atau dokumen kebijakan Instansi Pusat/Pemerintah Daerah lainnya.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            array(
                'indicator_id' => 7,
                'leveling_index_id' => 33,
                ...
                'description' => 'Instansi Pusat/Pemerintah Daerah sudah memiliki kebijakan internal penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah yang telah ditetapkan dan mengatur penggunaannya pada seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah.',
                'criteria_evidence' => 'Konteks pengaturan/norma pelaksanaan penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah bagi seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah tertuang dalam dokumen kebijakan Instansi Pusat/Pemerintah Daerah.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            array(
                'indicator_id' => 7,
                'leveling_index_id' => 34,
                'detail' => 'Kriteria tingkat 3 telah terpenuhi dan kebijakan internal terkait Penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah telah mengatur interoperabilitas Layanan Penghubung Layanan Instansi Pusat/Pemerintah Daerah dengan Layanan Penghubung Lainnya. Selain itu, kebijakan internal terkait Penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah telah direviu dan dievaluasi secara periodik.',
                'description' => 'Instansi Pusat/Pemerintah Daerah telah menerapkan kebijakan internal terkait penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah secara menyeluruh dan telah mengatur interoperabilitas dan akses Penghubung Layanan Instansi Pusat/Pemerintah Daerah dengan Layanan Penghubung lainnya, serta telah melakukan reviu dan/atau evaluasi terhadap kebijakan tersebut.',
                'criteria_evidence' => '1) Konteks pengaturan/norma arah kebijakan interoperabilitas dan akses pengoperasian Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah dengan Layanan Penghubung lainnya tertuang dalam dokumen kebijakan Instansi Pusat/Pemerintah Daerah; 2) Terdapat notulensi/catatan/laporan hasil evaluasi/reviu terkait kebijakan internal Layanan Penghubung yang masih berlaku (<2 tahun); 3) Hasil evaluasi/reviu yang berisi konten isu/permasalahan dan rekomendasi perbaikan yang aktual; dan 4) Bukti undangan rapat evaluasi kebijakan internal Layanan Penghubung, dan/atau dokumentasi aktivitas-aktivitas evaluasi kebijakan internal Layanan Penghubung (opsional).',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            array(
                'indicator_id' => 7,
                'leveling_index_id' => 35,
                ...
                'description' => 'Instansi Pusat/Pemerintah Daerah telah menindaklanjuti hasil reviu dan/atau evaluasi kebijakan pengoperasian Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah dengan menetapkan suatu kebijakan sebagai bentuk optimalisasi pelaksanaan kebijakan Penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah, sesuai dengan kebutuhan Instansi Pusat/Pemerintah Daerah ataupun perubahan lingkungan dan teknologi.',
                'criteria_evidence' => '1) Dokumen kebijakan internal penerapan SPBE Instansi Pusat/Pemerintah Daerah yang memuat kebijakan Penggunaan Sistem Penghubung dan telah optimal (memenuhi kriteria tingkat kematangan level 1 – 4); 2) Terdapat dokumentasi aktivitas reviu/penyempurnaan kebijakan internal Penggunaan Sistem Penghubung Layanan yang memuat rekomendasi; 3) Dokumen formal kebijakan internal Instansi Pusat/Pemerintah Daerah sebagai optimalisasi yang sesuai dengan rekomendasi hasil reviu/penyempurnaan; dan 4) Optimalisasi kebijakan dapat dipenuhi dengan menetapkan turunan kebijakan (SK, SE, SOP), dan kebijakan lainnya yang memuat substansi indikator sesuai arah rekomendasi reviu serta ditetapkan setidaknya 1 tahun setelah reviu dilakukan.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            ...
            array(
                ...
                'criteria_evidence' => '1) Konteks pengaturan/norma penerapan Manajemen Keamanan Informasi bagi seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah yang tertuang dalam dokumen kebijakan Instansi Pusat/Pemerintah Daerah; 2) Terdapat notulensi/catatan/laporan hasil evaluasi/reviu terkait kebijakan internal Manajemen Keamanan Informasi yang masih berlaku (<2 tahun); 3) Hasil evaluasi/reviu yang berisi konten isu/permasalahan dan rekomendasi perbaikan yang aktual; dan 4) Bukti undangan rapat evaluasi kebijakan internal Manajemen Keamanan Informasi, dan/atau dokumentasi aktivitas-aktivitas evaluasi kebijakan internal Manajemen Keamanan Informasi (opsional).',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            array(
                'indicator_id' => 8,
                'leveling_index_id' => 40,
                ...
                'criteria_evidence' => '1) Dokumen kebijakan internal penerapan SPBE Instansi Pusat/Pemerintah Daerah yang memuat kebijakan Manajemen Keamanan Informasi dan telah optimal (memenuhi kriteria tingkat kematangan level 1 – 4); 2) Terdapat dokumentasi aktivitas reviu/penyempurnaan kebijakan internal Manajemen Keamanan Informasi yang memuat rekomendasi; 3) Dokumen formal kebijakan internal Instansi Pusat/Pemerintah Daerah sebagai optimalisasi yang sesuai dengan rekomendasi hasil reviu/penyempurnaan; dan 4) Optimalisasi kebijakan dapat dipenuhi dengan menetapkan turunan kebijakan (SK, SE, SOP), dan kebijakan lainnya yang memuat substansi indikator sesuai arah rekomendasi reviu serta ditetapkan setidaknya 1 tahun setelah reviu dilakukan.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            ...
            array(
                'indicator_id' => 9,
                'leveling_index_id' => 44,
                'detail' => 'Kriteria tingkat 3 telah terpenuhi dan kebijakan internal terkait Audit TIK telah mengatur pelaksanaan Audit TIK untuk seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah. Selain itu, kebijakan internal terkait Audit TIK telah direviu dan dievaluasi secara periodik.',
                'description' => 'Kebijakan telah mengatur pelaksanaan Audit TIK untuk seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah dan kebijakan telah direviu dan/atau dievaluasi secara periodik.',
                'criteria_evidence' => '1) Konteks pengaturan/norma penerapan Audit TIK bagi seluruh unit kerja/perangkat daerah di Instansi Pusat/Pemerintah Daerah yang tertuang dalam dokumen kebijakan Instansi Pusat/Pemerintah Daerah; 2) Terdapat notulensi/catatan/laporan hasil evaluasi/reviu terkait kebijakan internal Audit TIK yang masih berlaku (<2 tahun); 3) Hasil evaluasi/reviu yang berisi konten isu/permasalahan dan rekomendasi perbaikan yang aktual; dan 4) Bukti undangan rapat evaluasi kebijakan internal Audit TIK, dan/atau dokumentasi aktivitas-aktivitas evaluasi kebijakan internal Audit TIK (opsional).',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
            array(
                'indicator_id' => 9,
                'leveling_index_id' => 45,
                ...
                'description' => 'Instansi Pusat/Pemerintah Daerah telah menindaklanjuti hasil reviu dan/atau evaluasi kebijakan pelaksanaan Audit TIK dengan menetapkan suatu kebijakan sebagai bentuk optimalisasi pelaksanaan kebijakan Audit TIK, sesuai dengan kebutuhan Instansi Pusat/Pemerintah Daerah ataupun perubahan lingkungan dan teknologi.',
                'criteria_evidence' => '1) Dokumen kebijakan internal penerapan SPBE Instansi Pusat/Pemerintah Daerah yang memuat kebijakan Audit TIK dan telah optimal (memenuhi kriteria tingkat kematangan level 1 – 4); 2) Terdapat dokumentasi aktivitas reviu/penyempurnaan kebijakan internal Audit TIK yang memuat rekomendasi; 3) Dokumen formal kebijakan internal Instansi Pusat/Pemerintah Daerah sebagai optimalisasi yang sesuai dengan rekomendasi hasil reviu/penyempurnaan; dan 4) Optimalisasi kebijakan dapat dipenuhi dengan menetapkan turunan kebijakan (SK, SE, SOP), dan kebijakan lainnya yang memuat substansi indikator sesuai arah rekomendasi reviu serta ditetapkan setidaknya 1 tahun setelah reviu dilakukan.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp
            ),
        ...
        DB::table('detail_leveling_indices')->insert($detail_leveling);
    }
}
